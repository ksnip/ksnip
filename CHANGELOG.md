...
* Fixed kImageAnnotator: Text tool does not allow me to type accents. ([#57](https://github.com/DamirPorobic/ksnip/issues/57))
...
* Fixed kImageAnnotator: Saved tool selection not loaded on startup. ([#67](https://github.com/DamirPorobic/ksnip/issues/67))
