...
#ifndef SETTINGSPICKERACTION_H
#define SETTINGSPICKERACTION_H
...
class SettingsPickerAction : public QAction
{
    Q_OBJECT

public:
    SettingsPickerAction(QWidget *parent = 0, int columns = -1);
