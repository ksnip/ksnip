...
WINDOWS_KITS_BIN="$WINDOWS_KITS/10/bin/10.0.18362.0"
WINDOWS_KITS_LIB="$WINDOWS_KITS/10/Lib/10.0.18362.0"
WINDOWS_KITS_INCLUDE="$WINDOWS_KITS/10/Include/10.0.18362.0"
