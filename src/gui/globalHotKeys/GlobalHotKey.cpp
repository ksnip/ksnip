...
GlobalHotKey::GlobalHotKey(QCoreApplication *app, const QKeySequence &keySequence) : mKeyHandler(nullptr)
{
    ...
    connect(keyEventFilter, &NativeKeyEventFilter::triggered, this, &GlobalHotKey::pressed);
