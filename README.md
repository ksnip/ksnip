...
# Dependencies
ksnip depends on [kImageAnnotator](https://github.com/ksnip/kImageAnnotator) and [kColoPicker](https://github.com/DamirPorobic/kColorPicker), which needs to be installed before building ksnip from source. Installation instructions can be found on the GitHub pages.
